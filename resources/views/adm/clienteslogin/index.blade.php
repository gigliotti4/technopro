@extends('adm.layouts')
@section('content')
<a href="{{route('nuevoclienteslogin')}}" class="btn btn-success mb-5" >Nuevo cliente</a>
  ...
  <tbody>
    <tr>
      ...
      <tr>
        ...
        <td scope="row" class="" >{{$u->email}}</td>
         {{-- <td scope="row"><img src="{{asset(Storage::url($a->imagen))}}" class="img-thumbnail w-25" ></td> --}}
        <td>
           <a class="btn btn-warning" href="{{route('editarclienteslogin', $u->id)}}" role="button">editar</a>
           <a class="btn btn-danger" href="{{route('eliminarclienteslogin', $u->id)}}" role="button">borrar</a>  
